...
## 2026-07-11 テーマE 起動画面パレット候補

OpenAI image generationで作成。起動画面 `startup-envelope-*-v3.png` の背景にある桜色、アプリコット、アイボリー、淡い青紫を、猫のシルエット内部へ移した比較案。透過はクロマキー除去で作成した。

| 生成日 | 候補 | 用途・特徴 | 配置先 |
|---|---|---|---|
| 2026-07-11 | e1 | 完全な円の丸まり・淡い水彩 | `public/illustrations/candidates/theme-e-splash-palette/e1.webp` |
| 2026-07-11 | e2 | 頭の起伏がある丸まり・白抜き最小線 | `public/illustrations/candidates/theme-e-splash-palette/e2.webp` |
| 2026-07-11 | e3 | 香箱・絵本寄り | `public/illustrations/candidates/theme-e-splash-palette/e3.webp` |
| 2026-07-11 | e4 | 円いリノカット風・顔なし | `public/illustrations/candidates/theme-e-splash-palette/e4.webp` |
| 2026-07-11 | e5 | 横たわり・紙繊維・白抜き目 | `public/illustrations/candidates/theme-e-splash-palette/e5.webp` |
| 2026-07-11 | e6 | 円形・wet-on-wet・顔なし | `public/illustrations/candidates/theme-e-splash-palette/e6.webp` |
| 2026-07-11 | e7 | 香箱・4色の面構成 | `public/illustrations/candidates/theme-e-splash-palette/e7.webp` |
| 2026-07-11 | e8 | 緩い三日月の丸まり・最小線 | `public/illustrations/candidates/theme-e-splash-palette/e8.webp` |

## 2026-07-12 E5方針比較

E5の横たわる猫を原案として、原案そのまま・彩度控えめ・単色ナビ候補の3方向を比較する。OpenAI image generationによる編集。形、姿勢、紙繊維、白抜きの表情は維持し、色のみを変更した。背景はクロマキー除去で透過WebP化。
...
## 2026-07-16 オンボーディングOG画像

| 作成日 | 用途 | 派生元・加工 | 配置先 |
|---|---|---|---|
| 2026-07-16 | onboardingリンクのSNSプレビュー | 記録済みの `startup-envelope-1170-2532-v3.png` から封筒と猫の封蝋を1200×630で切り出し、WebP quality 84へ変換。新規生成なし | `public/images/social/onboarding-og.webp` |
