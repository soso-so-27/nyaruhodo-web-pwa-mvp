    ...
    slots: [
      {
        ...
        iconPath: "/icons/collection/01_hesoten_belly_up.webp",
      },
      {
        id: "loaf",
        label: "ちょこん寝",
        group: "pose",
        silhouetteKey: "loaf",
        iconPath: "/icons/collection/02_kobako_loaf_pose.webp",
      },
      {
        id: "stretch",
        label: "のびー",
        ...
        iconPath: "/icons/collection/03_nobii_stretching.webp",
      },
      {
        id: "face-down-sleep",
        label: "ごめん寝",
        ...
        iconPath: "/icons/collection/04_gomennne_sorry_sleep.webp",
      },
      {
        id: "curled-up",
        label: "まるまり",
        ...
        iconPath: "/icons/collection/05_marumari_curled_up.webp",
      },
      {
        id: "liquid",
        label: "液体化",
        ...
        iconPath: "/icons/collection/06_ekitaika_melting.webp",
      },
      {
        id: "sitting",
        label: "おすわり",
        ...
        iconPath: "/icons/collection/07_osuwari_sitting.webp",
      },
      {
        id: "tail-up",
        label: "しっぽピーン",
        ...
        iconPath: "/icons/collection/08_shippo_piin_tail_up.webp",
      },
      {
        id: "weird-sleep",
        label: "変な寝相",
        ...
        iconPath: "/icons/collection/09_henna_nezou_weird_sleeping.webp",
      },
      {
        id: "hidden-paws",
        label: "おててないない",
        ...
        iconPath: "/icons/collection/10_otete_nainai_hidden_paws.webp",
      },
    ],
  },
  {
    ...
    slots: [
      {
        ...
        iconPath: "/icons/collection/11_hakoiri_in_box.webp",
      },
      {
        id: "by-window",
        label: "窓辺",
        ...
        iconPath: "/icons/collection/12_madobe_window_side.webp",
      },
      {
        id: "sunbathing",
        label: "ひなたぼっこ",
        ...
        iconPath: "/icons/collection/13_hinatabokko_sunbathing.webp",
      },
      {
        id: "in-futon",
        label: "布団入り",
        ...
        iconPath: "/icons/collection/14_futon_iri_under_covers.webp",
      },
      {
        id: "high-place",
        label: "高いところ",
        ...
        iconPath: "/icons/collection/15_takai_tokoro_high_place.webp",
      },
      {
        id: "waiting-food",
        label: "ごはん待ち",
        ...
        iconPath: "/icons/collection/16_gohan_machi_waiting_food.webp",
      },
      {
        id: "welcome-home",
        label: "お出迎え",
        ...
        iconPath: "/icons/collection/17_odemukae_greeting_door.webp",
      },
      {
        id: "blanket-kneading",
        label: "毛布ふみふみ",
        ...
        iconPath: "/icons/collection/18_moufu_fumifumi_kneading_blanket.webp",
      },
    ],
  },
];
