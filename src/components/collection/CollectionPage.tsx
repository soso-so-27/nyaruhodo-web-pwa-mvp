...
const styles = {
  ...
  mainichiBoardTape: {
    ...
    width: "58px",
    height: "16px",
    borderRadius: "7px 9px 8px 6px",
    background:
      "linear-gradient(90deg, rgba(255,255,255,0.24), rgba(255,255,255,0.04) 48%, rgba(255,255,255,0.18)), linear-gradient(180deg, color-mix(in srgb, var(--paper-card) 42%, transparent), color-mix(in srgb, var(--paper-warm) 54%, transparent)), var(--app-paper-background)",
    backgroundSize: "100% 100%, 100% 100%, var(--app-paper-background-size)",
    backgroundPosition: "0 0, 0 0, var(--app-paper-background-position)",
    backgroundRepeat: "no-repeat, no-repeat, var(--app-paper-background-repeat)",
    backgroundBlendMode: "screen, normal, multiply, normal, normal",
    boxShadow:
      "0 1px 0 rgba(255,255,255,0.34) inset, 0 -1px 0 rgba(92,72,45,0.05) inset, 0 4px 10px rgba(120,110,90,0.11)",
    opacity: 0.78,
