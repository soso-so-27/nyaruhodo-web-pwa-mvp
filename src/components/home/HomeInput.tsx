...
const styles = {
  ...
  catSwitchChip: {
    ...
    boxShadow:
      "0 8px 22px rgba(0,0,0,0.16), inset 0 1px 0 rgba(255,255,255,0.24)",
  },
  catSwitchChipActive: {
    display: "inline-flex",
    alignItems: "center",
    ...
    boxShadow:
      "0 10px 28px rgba(0,0,0,0.18), inset 0 1px 0 rgba(255,255,255,0.35)",
  },
  catSwitchAvatar: {
    width: "44px",
    height: "44px",
    ...
    overflow: "hidden",
    flexShrink: 0,
    background: "rgba(245,243,239,0.42)",
    display: "inline-flex",
    alignItems: "center",
    justifyContent: "center",
  },
