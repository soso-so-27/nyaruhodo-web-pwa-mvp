...
const styles = {
  ...
  photoHero: {
    position: "relative",
    height: "430px",
    border: "1px solid rgba(221, 217, 208, 0.84)",
    borderRadius: "30px",
    background: "#fbfaf7",
    overflow: "hidden",
    boxShadow: "0 14px 30px rgba(43, 40, 34, 0.045)",
  },
  photoHeroImage: {
    position: "absolute",
    top: 0,
  ...
  understandingPanel: {
    ...
    boxShadow: "0 12px 24px rgba(43, 40, 34, 0.06)",
    padding: "8px 7px 9px",
  ...
  dashboardTile: {
    ...
    flexDirection: "column",
    gap: "3px",
    borderRight: "1px solid rgba(222, 219, 211, 0.76)",
    background: "transparent",
    padding: "7px 9px",
  },
  dashboardTileLast: {
  ...
  observationCard: {
    marginBottom: "12px",
    border: "1px solid rgba(226, 223, 216, 0.82)",
    borderRadius: "28px",
  ...
  embeddedSection: {
    paddingTop: "12px",
    marginTop: "12px",
    borderTop: "1px solid rgba(232, 229, 221, 0.78)",
  },
  ...
  currentButton: {
    ...
    borderColor: "rgba(224, 221, 214, 0.82)",
  },
  concernButton: {
    background: "rgba(250, 249, 246, 0.74)",
    borderColor: "rgba(226, 223, 216, 0.8)",
    fontWeight: 500,
    minHeight: "88px",
    gap: "5px",
    padding: "8px 6px 9px",
