...
function renderOptionIconPath(kind: OptionIconKind) {
  switch (kind) {
    ...
    case "food":
      return (
        <>
          <path d="M5.2 11.2h13.6l-1.3 5.5H6.5L5.2 11.2Z" />
          <path d="M7.3 11.2c.5-1.8 2.2-2.9 4.7-2.9s4.2 1.1 4.7 2.9" />
          <path d="M8.5 18.7h7" />
          <circle cx="9.3" cy="13.8" r=".45" />
          <circle cx="12" cy="14.5" r=".45" />
          <circle cx="14.7" cy="13.8" r=".45" />
        </>
      );
    case "toilet":
      return (
        <>
          <path d="M5.8 9.4h12.4l-1.1 8.2H6.9L5.8 9.4Z" />
          <path d="M8.1 9.4 8.8 6h6.4l.7 3.4" />
    ...
    case "purring":
      return (
        <>
          <path d="M4.7 8.7c1.5-1.4 3-1.4 4.5 0s3 1.4 4.5 0 3-1.4 4.6 0" />
          <path d="M4.7 12c1.5-1.4 3-1.4 4.5 0s3 1.4 4.5 0 3-1.4 4.6 0" />
          <path d="M4.7 15.3c1.5-1.4 3-1.4 4.5 0s3 1.4 4.5 0 3-1.4 4.6 0" />
        </>
      );
    case "meowing":
      return (
    ...
    case "following":
      return (
        <>
          <path d="M6.4 8.6c.7-.7 1.9-.7 2.6 0s.7 1.9 0 2.6-1.9.7-2.6 0-.7-1.9 0-2.6Z" />
          <path d="M13.8 13.6c.7-.7 1.9-.7 2.6 0s.7 1.9 0 2.6-1.9.7-2.6 0-.7-1.9 0-2.6Z" />
          <path d="M10.2 11.6 13 13.5" />
          <path d="M15.6 7.2h3.3v3.3" />
          <path d="m18.8 7.3-5 5" />
        </>
      );
    case "restless":
      return (
        <>
          <path d="M4.5 12.7c1.6-2.6 3.3-2.6 4.9 0s3.3 2.6 4.9 0 3.1-2.6 4.5-.5" />
          <path d="M6.5 17h11" />
          <path d="M7.3 7.8 5.8 6.3" />
          <path d="m16.7 7.8 1.5-1.5" />
        </>
      );
    case "low_energy":
      return (
