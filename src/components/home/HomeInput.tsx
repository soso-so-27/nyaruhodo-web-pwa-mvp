...
const styles = {
  ...
  homeInstallHintCard: {
    ...
    background:
      "linear-gradient(145deg, rgba(255,253,248,0.86), rgba(248,243,234,0.72))",
    boxShadow:
      "0 10px 24px rgba(90,76,60,0.075), inset 0 1px 0 rgba(255,255,255,0.58)",
  ...
  homeInstallHintPrimary: {
    ...
    background: "rgba(154,134,107,0.84)",
    color: "#fffdf8",
    fontSize: "12.5px",
    fontWeight: 620,
    letterSpacing: "0.03em",
    boxShadow: "0 6px 14px rgba(90,76,60,0.085)",
    cursor: "pointer",
    whiteSpace: "nowrap",
  },
