...
const privacySections = [
  ...
  },
  {
    title: "削除と問い合わせ",
    body: [
      "端末内のデータは設定画面から削除できます。アカウントに保存されたデータや、ねこだより候補として扱われた写真の削除については、ベータ期間中は /contact または運営者が案内する連絡先からお問い合わせください。",
      "削除依頼では、確認に必要な範囲で、利用日時、画面、写真の特徴などを伺うことがあります。秘密情報や署名付きURLを送る必要はありません。",
