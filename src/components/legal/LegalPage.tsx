...
const privacySections = [
  ...
  },
  {
    ...
    body: [
      ...
      "とったねがおを「ほかのおうちへ送る」で保存した場合、名前を出さずにほかの利用者へとどく候補になることがあります。名前、連絡先、プロフィール詳細、場所は相手には表示しません。",
...
const termsSections = [
  ...
  },
  {
    title: "とどくねこだより",
    body: [
      "とったねがおを「ほかのおうちへ送る」で保存した場合、ほかの利用者へとどく候補になります。写真が並ぶ公開一覧や、利用者同士の交流機能はありません。",
      "とどいた猫が複数いる場合は、1匹を選んで「ねこだより」に残す、どの猫も残さない、運営に報告することができます。報告された猫は確認のうえ、表示対象から外すことがあります。",
    ],
  },
  {
    title: "A-3. 写真の削除",
  ...
  return (
    ...
    >
      ...
      <section style={styles.section}>
        ...
        <p style={styles.paragraph}>
          「うちのこ」で写真をひらくと、ほかのおうちへの送信設定を変更できます。通常の追加写真は、同じ写真詳細から削除できます。
        </p>
