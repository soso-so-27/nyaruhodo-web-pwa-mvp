...
const termsSections = [
  ...
  },
  {
    ...
    body: [
      ...
      "届いた寝顔は、しまう、閉じる、通報することができます。通報された写真は確認のうえ、表示対象から外すことがあります。",
    ],
  },
  {
    title: "A-3. 写真の削除",
  ...
  },
  {
    ...
    body: [
      ...
      "βサポーターは、ねてるねこの開発と運営を応援する月額1,500円（税別、税込1,650円）の有料プランです。加入の有無によって、毎日の基本的な体験が制限されることはありません。",
      "βサポーター向けの特典等を提供する場合は、内容を別途案内します。",
      ...
      "有料プランを解約した場合でも、ご自身が保存した写真、および届いたねこだよりの閲覧が失われることはありません。",
    ],
  },
  {
...
const contactSections = [
  {
    title: "問い合わせ方法",
    body: [
      "返信が不要な感想、不具合、分かりにくかった点は、設定画面の「改善メモを書く」から送信できます。",
...
const accountDeletionSections = [
  ...
  },
  {
    ...
    body: [
      "ねがおを削除したいときは、「ねこだより」のおくったから写真をひらき、写真の操作にある削除アイコンを押して、確認画面で「削除」を選びます。",
...
const cancellationSections = [
  {
    ...
    body: [
      ...
      "設定画面の「参加と応援」から「支払いを管理・解約」を開き、Stripeの支払い管理画面へ進んでください。",
    ],
  },
  {
    title: "反映タイミング",
  ...
  },
  {
    ...
    body: [
      ...
      "とる、届く、しまう、アルバム、猫プロフィールは、サポーター状態によって制限しません。",
    ],
  },
] as const satisfies readonly LegalSection[];
...
const commercialTransactionsSections = [
  ...
  {
    title: "販売価格",
    body: ["有料プラン 月額1,500円（税別）／お支払い額 月額1,650円（税込）"],
  },
  {
    title: "商品代金以外の必要料金",
    body: [
  ...
  return (
    ...
    >
      ...
      <section style={styles.section}>
        ...
        <p style={styles.paragraph}>
          写真をひらき、写真の操作から削除を選んでください。ねがおは「ねこだより」のおくったから、この子の写真は「うちのこ」の写真から操作できます。
        </p>
