...
const accountDeletionSections = [
  ...
  },
  {
    ...
    body: [
      "写真を1枚だけ削除する場合、ねこだよりは手紙と同じで、一度届いたぶんは、受け取った方の記録として表示が残ることがあります。",
      "アカウントとデータ全体の削除では、保存されている写真ファイルも削除対象になるため、届いた先で写真を表示できなくなることがあります。",
      "削除された写真が、それ以降あたらしく届くことはありません。",
      "もし、どうしても届いた先からも消したい事情がある場合は、設定の「問い合わせ」からご連絡ください。事情をうかがったうえで対応を検討します。",
    ],
  },
  {
    title: "対応の目安",
