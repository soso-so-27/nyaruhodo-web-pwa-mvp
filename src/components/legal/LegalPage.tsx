...
const termsSections = [
  ...
  },
  {
    ...
    body: [
      ...
      "とどいたねこだよりが複数ある場合は、1枚を選んで「とどいた」に保存する、どのねこだよりも保存しない、運営に報告することができます。報告されたねこだよりは確認のうえ、表示対象から外すことがあります。",
    ],
  },
  {
    title: "A-3. 写真の削除",
...
const accountDeletionSections = [
  ...
  },
  {
    ...
    body: [
      "ねがおを削除したいときは、「ねこだより」の「わたしのねがお」から写真をひらき、写真の操作にある削除アイコンを押して、確認画面で「削除」を選びます。",
      "この子の写真を削除したいときは、うちのこ「写真」から写真をひらき、「この写真を削除」を選びます。",
      "「わたしのねがお」から削除した写真は、今後のねこだよりには使われません。「この子の写真」はプロフィール内から削除され、もともとねこだよりには使われません。",
    ],
  },
  {
  ...
  return (
    ...
    >
      ...
      <section style={styles.section}>
        ...
        <p style={styles.paragraph}>
          写真をひらき、写真の操作から削除を選んでください。ねがおは「ねこだより」の「わたしのねがお」から、この子の写真は「うちのこ」の写真から操作できます。
        </p>
