...
const accountDeletionSections = [
  ...
  },
  {
    ...
    body: [
      "「うちのこ」の「写真」から対象の写真をひらき、「この写真を削除」を選びます。",
      "ねがおを削除すると、今後のねこだよりには使われません。すでに相手へとどいた写真は、その人の記録に残ります。",
      "通常追加した「この子の写真」はプロフィール内から削除され、もともとねこだよりには使われません。",
    ],
  },
  {
...
export function AccountDeletionPage() {
  ...
  return (
    ...
    >
      ...
      <section style={styles.section}>
        <h2 style={styles.sectionTitle}>写真ごとの設定・削除</h2>
        <p style={styles.paragraph}>
          「うちのこ」で写真をひらくと、ねこだよりへの送信設定を変更できます。通常の追加写真は、同じ写真詳細から削除できます。
        </p>
