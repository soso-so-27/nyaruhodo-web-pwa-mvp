...
const privacySections = [
  ...
  },
  {
    ...
    body: [
      ...
      "ログイン前の体験では、匿名ID、オンボーディングの進行状況、写真送信やねこだよりをひらくなどの利用イベントを扱うことがあります。",
    ],
  },
  {
    title: "利用目的",
    bullets: [
      "猫ごとの写真、ねがお、おきてる写真、ねこだよりを表示するため",
      "ログイン後に、この端末のデータをねてるねこのアカウントへ保存し、別の端末へ取り込むため",
  ...
  },
  {
    title: "写真とねがお",
    body: [
      "写真は、利用者が選択した範囲で保存されます。ログイン前はこの端末内に保存され、Googleでログインして設定の「アカウント保存を更新する」を行った場合は、ねてるねこのアカウントにも保存されます。",
      "とったねがおを「ねこだよりにする」で保存した場合、ねてるねこの中で、名前を出さずにほかの利用者へとどくねこだよりの候補になることがあります。名前、連絡先、プロフィール詳細、場所は相手には表示しません。",
  ...
  },
  {
    title: "削除と問い合わせ",
    body: [
      "アカウントに保存されたデータの削除を希望する場合は、設定画面の「解約・データ削除・退会について」を確認し、問い合わせ導線から「削除希望」と送ってください。",
...
const termsSections = [
  ...
  },
  {
    title: "このアプリの役割",
    body: [
      "ねてるねこは、猫のねがおや写真を保存し、あとから見返すための写真記録アプリです。獣医療上の診断、治療、緊急判断の代わりにはなりません。",
  ...
  },
  {
    title: "A-2. 投稿写真の審査",
    body: [
      "投稿写真は、他のユーザーへとどく前に、運営者による確認（審査）を行います。",
      "運営者は、ねこが写っていないもの、人物が特定できる形で写り込んでいるもの、法令または公序良俗に反するもの、第三者の権利を侵害するもの、他人が撮影した写真を権利者の許諾なく投稿したもの、その他本サービスの趣旨に照らして不適切と判断したものを、他のユーザーへとどく対象から除外することがあります。",
  ...
  },
  {
    title: "とどくねこだより",
    body: [
      "とったねがおを「ねこだよりにする」で保存した場合、ほかの利用者へとどくねこだよりの候補になります。写真が並ぶ公開一覧や、利用者同士の交流機能はありません。",
      "とどいたねこだよりが複数ある場合は、1枚を選んで「ねこだより」に残す、どのねこだよりも残さない、運営に報告することができます。報告されたねこだよりは確認のうえ、表示対象から外すことがあります。",
    ],
  },
  {
    title: "A-3. 写真の削除",
    body: [
      ...
      "削除された写真は、以後、他のユーザーへとどく対象から除外されます。",
      "削除の時点ですでに他のユーザーへとどいたねこだよりについては、当該ユーザーの受け取りの記録として表示が残ることがあります。運営者は、特段の事情（権利侵害等）がある場合を除き、とどいた先からの個別の削除は行いません。",
  ...
  },
  {
    title: "アカウントと保存",
    body: [
      "Googleでログインすると、端末内の猫データや写真をねてるねこのアカウントへ保存し、別の端末へ取り込めるようになります。Googleはログイン認証に使用し、写真をGoogleドライブへ保存する機能ではありません。アカウント保存の更新は利用者の操作によって行われ、すべての端末へ自動で反映されることを保証するものではありません。",
    ],
  },
  {
    title: "A-4. 有料プラン",
    body: [
      "本サービスの基本機能（ねがおを とると、ねこだよりがとどく体験）は、無料で利用できます。",
      "βサポーターは、ねてるねこの開発と運営を応援する月額1,650円（税込、税別1,500円）の有料プランです。",
      "β期間中は、βサポーターへの加入による機能差はありません。",
      "有料プランの利用料金は、決済代行事業者（Stripe, Inc.）を通じて毎月自動的に決済されます。",
      "解約は、アプリ内の支払い管理画面からいつでも行えます。解約後も、当該課金期間の末日まではβサポーターとして表示されます。",
      "期間途中で解約した場合の日割り返金は行いません。ただし、運営者の責めに帰すべき事由によりサービスを利用できなかった場合はこの限りではありません。",
      "有料プランを解約したあとも、ご自身が保存した写真と、ねこだよりは引き続き閲覧できます。",
    ],
  },
  {
    title: "A-5. サービスの変更・中断・終了",
    body: [
...
const contactSections = [
  {
    title: "問い合わせ方法",
    body: [
      "返信が不要な感想、不具合、分かりにくかった点は、設定画面の「感想・不具合・要望を送る」から送信できます。",
      "削除依頼、通報の補足、ログインできない場合、支払いに関する相談など、返信や本人確認が必要な内容は問い合わせとして受け付けます。",
      "権利侵害に関する申立て（ご自身やねこの写真が無断で使われている等）も、こちらの窓口で受け付けます。",
      "Instagramなどの案内から利用した方は、案内元の運営者アカウントへ連絡してください。正式な連絡先メールアドレスも下に記載しています。",
    ],
  },
  {
    title: "送れる内容",
...
const accountDeletionSections = [
  {
    ...
    body: [
      ...
      "すでにおとどけしたねこだよりは、受け取った方の記録に残ります。",
    ],
    bullets: [
      "アカウント情報",
      "猫のプロフィールと記録",
      ...
      "思い出便と思い出箱の記録",
      "通報や問い合わせ対応に必要な記録",
      "保存されている写真ファイル（すでにねこだよりとして相手にとどいた写真を除く）",
    ],
  },
  {
    title: "依頼方法",
  ...
  },
  {
    ...
    body: [
      "ねがおを削除したいときは、「ねこだより」の「ねこだよりに送る写真の設定」から写真をひらき、写真の操作にある削除アイコンを押して、確認画面で「削除」を選びます。",
      "この子の写真を削除したいときは、うちのこ「写真」から写真をひらき、「この写真を削除」を選びます。",
      "「ねこだよりに送る写真の設定」から削除した写真は、今後のねこだよりには使われません。「この子の写真」はプロフィール内から削除され、もともとねこだよりには使われません。",
    ],
  },
  {
    title: "すでにどなたかにとどいたねこだよりについて",
    body: [
      "一度とどいた ねこだよりは、受け取った方の記録として残ります。",
      "写真を削除しても、アカウントを削除しても、それ以降あたらしくとどくことはありません。",
      "もし、どうしてもとどいた先からも消したい事情がある場合は、お問い合わせください。事情をうかがったうえで対応を検討します。",
    ],
  },
  {
    title: "対応の目安",
...
const cancellationSections = [
  {
    ...
    body: [
      ...
      "設定画面の「参加と応援」から「支払いを管理・解約」をひらき、Stripeの支払い管理画面へ進んでください。",
    ],
  },
  {
    title: "反映タイミング",
  ...
  },
  {
    ...
    body: [
      ...
      "ねがおの写真を選ぶ、ねこだよりがとどく、写真を保存して見返す、猫プロフィールを使う基本体験は、サポーター状態によって制限しません。",
    ],
  },
] as const satisfies readonly LegalSection[];
...
const commercialTransactionsSections = [
  ...
  {
    title: "販売価格",
    body: ["お支払い額 月額1,650円（税込、税別1,500円）"],
  },
  {
    title: "商品代金以外の必要料金",
    body: [
...
export function AccountDeletionPage() {
  ...
  async function handleOpenPortal() {
    ...
    if (result.reason === "login_required") {
      setPortalMessage("ログインの有効期限が切れたため、支払い管理をひらけませんでした。");
      setPortalNeedsAuthRecovery(true);
    } else {
      setPortalMessage("支払い管理をひらけませんでした。通信を確認して、もう一度お試しください。");
    }
  ...
  return (
    ...
    >
      {showPaymentManagement ? (
        <section data-testid="account-delete-payment-block" style={styles.section}>
          ...
          <p style={styles.paragraph}>
            退会は不要です。ねこだよりも、保存した写真も、そのまま使いつづけられます。
          </p>
          <AppButton
            type="button"
            variant="secondary"
      ...
      <section style={styles.section}>
        ...
        <p style={styles.paragraph}>
          写真をひらき、写真の操作から削除を選んでください。ねがおは「ねこだより」の「ねこだよりに送る写真の設定」から、この子の写真は「うちのこ」の写真から操作できます。
        </p>
      ...
      {billingStatus.isLoggedIn ? (
        <section data-testid="account-delete-request-block" style={styles.section}>
          ...
          <p style={styles.paragraph}>
            すでに相手へとどいたねこだよりは、受け取った方の記録として残ります。
          </p>
          <p style={styles.importantParagraph}>
            退会すると、お支払いは同時に停止します。日割りの返金はなく、βサポーター表示もその時点で終了します。
          </p>
...
function LegalPage({ title, lead, updatedAt, sections }: LegalPageProps) {
  return (
    <LegalFrame title={title} lead={lead} updatedAt={updatedAt}>
      ...
      <p style={styles.note}>
        このページはベータ版として公開中です。内容を更新することがあります。
      </p>
    </LegalFrame>
  );
}
